...
public abstract class GenericHibTemplateDAOImpl <T extends Model.Entity, ID extends Serializable>  
...
//			System.out.println(entr.getKey()+"   ïðèìèòèâ èëè îáüåêò??   "+isPrimitiveOrWrapped+"   ñòðîêà ëè?  "+valclazz.equals(String.class));
