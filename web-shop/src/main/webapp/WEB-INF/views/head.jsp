...
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/trackbar.css" />" />
	<script type="text/javascript" src="<c:url value="/resources/trackbar.js" />"></script>
...
<script type="text/javascript" src="masked_input.js"></script>
...
<script type="text/javascript" src="http://js.mobilluck.com.ua/js/popups.js"></script>
...
var debug1 = '', mt, mStatus, mt2;
	...
	<script src="http://js.mobilluck.com.ua/nd/js/slides.min.jquery.js"></script><script type="text/javascript" src="http://js.mobilluck.com.ua/js/adriver.js"></script>