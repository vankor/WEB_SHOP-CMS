...
<title>Корзина заказов MOBILLUCK</title>
...
<script type="text/javascript" src="http://js.mobilluck.com.ua/js/jcarousellite.js"></script>
	<script type="text/javascript" src="http://js.mobilluck.com.ua/js/cart.js"></script><script type="text/javascript" src="http://js.mobilluck.com.ua/js/jquery.autocomplete.js"></script><script type="text/javascript">
var dt = new Date();
...
$(document).ready(function(){
	...
	$("#popup_close").bind("click", function(){
		...
		$("#popup_wrapper").hide();
					change_delivery();
			//refresh_cart('35mj026dv47f5mja5c7ecseg83', '100', '');
					return false;
	});
	...
	<div id="topmenu">
		...
		<tr>
			...
			<td class="head_basked">
				<div class="baskedbox">
					<div class="basked">
						<p class="basked_items_count"><span style="position:relative; top:2px; right:0">4</span></p><div class="basked_img"></div><span class="text">Корзина</span>
						<div class="trigger">&nbsp;</div>
					</div>
						<div class="basked_items_list">
									<table>
										<tr><td class="h_busc_name">Игровая приставка Genius Heeha 600</td><td class="h_busc_count">4</td><td class="h_busc_price"><span>424 грн</span></td></tr>													<tr>
													...
													<tr>
														<td colspan='3' class="oform_it" >
															...
															<p class="cart_edit" onclick="loadup2( '35mj026dv47f5mja5c7ecseg83');">Редактировать</p>
														</td>
													</tr>
																						</table>
						</div>
					...
					<div class="mymob">
						...
						<div class="mymob_items_list">
							<table>
										...
										<tr>
											<td class="h_mymob_item">
												<a href="http://www.mobilluck.com.ua/user_room.php?mode=personal_data"><span>Личные данные</span></a>
											</td>
										</tr>
										<tr>
...
<div id="main" >	<div id="mccart">
    		<div class="checkout-middle-title">
					<h1>ОФОРМЛЕНИЕ ЗАКАЗА</h1>
</div>
<div id='content_ch'>
	<div class='zakaz_of'>
		<form action='/cart.php' method="POST" id="form"  onsubmit="return testname();">
		<input type="hidden" name="frsc" value="s63g5to1w1"/>
		<table class='item_f'>
			...
			<tr>
						...
						<table>
							...
							<tr>
								...
								<td class='right_f line_f'>
									<input type="text" id="clientname_f" name="clientname" value="Иван" >
								...
								<td id="tmpp">
									<div id="phones">
										<div>
											...
											<input type="text" class="clientphone_f" name="clientphone_number[]" value="">
										</div>
																			</div>
									<div style="clear:both;margin:2px 0 0 0"><a onclick="plus()" style="text-decoration:none; color:black; cursor:pointer; margin-top:3px;"><img src="img/checkout/plus.png"><span style="font:normal 10px arial"> Добавить дополнительный номер</span></a></div>
									<script type="text/javascript">
									function plus(){ //Заменить
										$("#phones").append('<div style="clear:both"><select class="phone_f" name="clientphone_code[]"><option value="+380">UA</option><option value="+7">RU</option><option value="+375">BEL</option><option value="+373">MOL</option></select><input onload="maskit(this)"  type="text" style="float:left;margin: 0 0 0 7px; width: 150px;" name="clientphone_number[]" value="" style="display: block; "><div><div style="float:right;margin:5px 0 0 0"><a onclick="minus(this)" style="text-decoration:none; color:black; cursor:pointer;"><img src="img/checkout/minus.png"></a></div></div></div>');
										$(".phone_f").selectbox();
							...
							<tr>
								...
								<td>
									<input type="text" id="clientemail_f" name="clientemail" value="vankor1991@gmail.com"  >
								</td>
							</tr>
							...
							<tr class='srochnost_f'>
								...
								<td class='right_f'>
									<label id="data_f" onmouseup="check(this)" for='srochnost' >
										<p class='checkbox_f'>
											<input id='srochnost' type='checkbox' name='clientsrochnost' value='1' style='display:none'  >
										</p>
				...
				<td class='second_f'>
					...
					<div class='cont'>
							...
							<tr id='city_f'>
								...
								<td class='right_f'>
								<script type="text/javascript" src="http://www.mobilluck.com.ua/js/jquery.autocomplete.js"></script>
								...
								<div id="cities">
										...
										<div class="citiess_inp">
											...
											<input type="hidden" name="clienttown" id="clienttown" value="0">
										</div>
							...
							<tr id="oplata_f">
								...
								<td class='right_f'>
									<select name="clientoplata" id="clientoplata_f" onchange="select_clientoplata(this);">
                						<option value="1" >Наличный</option><option value="2" >Безналичный</option><option value="7" >Картой Visa/MasterCard</option><option value="14" >Онлайн-Кредит</option>                					</select>
									<script type="text/javascript">
							...
							<tr  id="dostavka_f">
								...
								<td class='right_f'>
									<select name="clientdeliverytype" id="clientdeliverytype_f" onclick="showhelp(this);" onchange="select_clientdeliverytype(this);">
                						<option value="2" >Доставка в офис для самовывоза</option><option value="1" >Адресная доставка по городу</option><option value="6" >Мист Экспресс адресная</option><option value="5" >Мист Экспресс в пункт самовывоза</option><option value="3" >Новая Почта в пункт самовывоза</option><option value="4" >Новая Почта адресная</option>                					</select>
								</td>
								<script type="text/javascript">
							...
							<td class='left_f space_f' colspan='2'></td>
														...
														<tr id="adress_fr" style="display: none;">
								<td class='left_f'>
								...
								<td class='right_f' id="delivery_td">
									...
									<div id="adress_pg">
										...
										<div id="add_param">
											...
											<div style="clear:both" id="netajbl">
											...
											<div style="clear:both" id="nliftbl">
									...
									<!-- Если филиал для самовывоза -->
									<div id="adress_filial"  style="display:none">
										<label id="label_branch"></label>
										<select name="filial_adress" id="filial_adress_f" onclick="showhelp(this);" onchange="select_clientdeliverytype(this);">
                						</select>
									</div>
																	</td>
							</tr>
				...
				<td class='third_f'>
					...
					<div class='discount_f' id="promoballsblock" style="height: 140px;"><!-- добавить класс disabled_f  - если нет балов -->
						<div id='radio_f'>

							
							<div>
								<label class='' onclick="refresh_cart('35mj026dv47f5mja5c7ecseg83', '100', '');">
									<p class="chkdsk">
							...
							<div>
								<label class='checked_f' onclick="refresh_cart('35mj026dv47f5mja5c7ecseg83', '100', '');">
									<p class="chkdsk">
						...
						<div style="clear:both; display: block;" class="promo_f" id="promoinput">
							...
							<div id="promo_input" style="display: block;">
								<input type="text" name="promo" id="promo" placeholder="Например, 1234-1234-1234-1234" placeholder2="Например, 1234-1234-1234-1234"><label><p class="recount"><label onclick="return setpromo(this, '35mj026dv47f5mja5c7ecseg83')"><span>Пересчитать</span><input type="submit" style="display:none"></p></label>
							</div>
							<div id="promo_ok" style="padding: 0px; font-weight: normal; font-size: 12px; display: none;">
		                        Введен промо-код: <b></b>
                                <br />
                                <a href="javascript:void();" onclick="delpromo('35mj026dv47f5mja5c7ecseg83', '')">отменить использование промо-кода</a>
							</div>
...
var flags = {
	'UA': '<img src="img/flags/Flags-00.png"><p style="display:none">UA</p>',
	'RU': '<img src="img/flags/Flags-01.png"><p style="display:none">RU</p>',
	'BEL': '<img src="img/flags/Flags-02.png"><p style="display:none">BEL</p>',
	'MOL': '<img src="img/flags/Flags-03.png"><p style="display:none">MOL</p>'};
...
<script type='text/javascript'>
	...
	function change_payment()
	{
		...
		$.ajax({
			type: "POST",
			url: "/ajx/ajx_cart.php",
			data: 'cmd=uh_com_get_payment_type&city_id='+city_id+'&csi=35mj026dv47f5mja5c7ecseg83',
			dataType: "text",
			success: function(data)
			{
				var tmp = data.split("|");
	...
	function change_delivery()
	{
		...
		$.ajax({
			type: "POST",
			url: "/ajx/ajx_cart.php",
			data: 'cmd=uh_com_get_delivery_type&city_id='+city_id+'&payment_id='+payment_id+'&fc='+fopcredit+'&csi=35mj026dv47f5mja5c7ecseg83',
			dataType: "text",
			success: function(data)
			{
				var tmp = data.split("|");
	...
	function load_branch()
	{
		...
		$.ajax({
			type: "POST",
			url: "/ajx/ajx_cart.php",
			data: 'cmd=uh_com_get_load_branch&city_id='+city_id+'&delivery_id='+delivery_id+'&payment_id='+payment_id+'&csi=35mj026dv47f5mja5c7ecseg83',
			dataType: "text",
			success: function(data)
			{
				//alert(data);
	...
	function refresh_cart(sesid, usrbal, usrdisc)
	{
		...
		$.ajax({
			type: "POST",
			url: "/ajx/ajx_cart.php",
			data: 'cmd=uh_com_cartitems_sm&csi='+sesid+'&ds='+ds+'&os='+os+'&rt='+rt+'&bl='+bl+'&dct='+usrdisc+"&twn="+twn+tt+'&delivdeliv='+delivery_delivery+'&zanos='+zanos+'&etag='+etag+'&lift='+lift	,
			dataType: "text",
			success: function(data){
				if( data != "" )
				{
							...
							<ul>
									...
									<li>
										<a href="http://www.mobilluck.com.ua/katalog/game-stations/jxd/jxd-S601_black-104928.html">
											<img style="margin: 14px 0px;" src="http://img.mobilluck.com.ua/img/spacer.gif" data-original="http://pics.mobilluck.com.ua/ico/game-stations/jxd/JXD_S601_black_104928_380975.jpg" width="50" height="22" alt="Игровая приставка на Android JXD S601 Black">
										</a>
										<p class="v-title">
										...
										<p>
											<span class="v-price">873 грн</span>
											<span class="v-old-price"></span>
										</p>
									</li>
									
									<li>
										<a href="http://www.mobilluck.com.ua/katalog/game-stations/globex/globex-PGP-100_Red-271435.html">
											<img style="margin: 0px 0px;" src="http://img.mobilluck.com.ua/img/spacer.gif" data-original="http://img.mobilluck.com.ua/img/nophoto.gif" width="50" height="50" alt="Игровая консоль Globex PGP-100 Red">
										</a>
										<p class="v-title">
											<a href="http://www.mobilluck.com.ua/katalog/game-stations/globex/globex-PGP-100_Red-271435.html">Игровая консоль Globex PGP-100 Red</a>
										</p>
										<p>
									...
									<li>
										<a href="http://www.mobilluck.com.ua/katalog/game-stations/globex/globex-PGP-200_Blue-271436.html">
											<img style="margin: 11px 0px;" src="http://img.mobilluck.com.ua/img/spacer.gif" data-original="http://pics.mobilluck.com.ua/ico/game-stations/globex/Globex_PGP-200_Blue_271436_533180.jpg" width="50" height="29" alt="Игровая консоль Globex PGP-200 Blue">
										</a>
										<p class="v-title">
											<a href="http://www.mobilluck.com.ua/katalog/game-stations/globex/globex-PGP-200_Blue-271436.html">Игровая консоль Globex PGP-200 Blue</a>
										</p>
										<p>
											<span class="v-price">269 грн</span>
											<span class="v-old-price"></span>
										</p>
									</li>
									
									<li>
										<a href="http://www.mobilluck.com.ua/katalog/game-stations/globex/globex-PGP-100_Blue-271434.html">
											<img style="margin: 0px 0px;" src="http://img.mobilluck.com.ua/img/spacer.gif" data-original="http://img.mobilluck.com.ua/img/nophoto.gif" width="50" height="50" alt="Игровая консоль Globex PGP-100 Blue">
										</a>
										<p class="v-title">
											<a href="http://www.mobilluck.com.ua/katalog/game-stations/globex/globex-PGP-100_Blue-271434.html">Игровая консоль Globex PGP-100 Blue</a>
										</p>
										<p>
											<span class="v-price"></span>
											<span class="v-old-price"></span>
									...
									<li>
										<a href="http://www.mobilluck.com.ua/katalog/game-stations/globex/globex-PGP-210_Pink-271439.html">
											<img style="margin: 12px 0px;" src="http://img.mobilluck.com.ua/img/spacer.gif" data-original="http://pics.mobilluck.com.ua/ico/game-stations/globex/Globex_PGP-210_Pink_271439_533177.jpg" width="50" height="27" alt="Игровая консоль Globex PGP-210 Pink">
										</a>
										<p class="v-title">
											<a href="http://www.mobilluck.com.ua/katalog/game-stations/globex/globex-PGP-210_Pink-271439.html">Игровая консоль Globex PGP-210 Pink</a>
										</p>
										<p>
											<span class="v-price"></span>
											<span class="v-old-price"></span>
...
function feedback(topic, lnk, ttop)
{
	...
	$.ajax({
		...
		success: function(data){
			...
			var xcnt_basket_products = '290230';
			(function(){
			...
			<script src="http://rt.actionpay.ru/code/mobilluck/" defer></script><script>window.APRT_DATA = { pageType: 4, basketProducts: [{ id: 290230, name: 'Игровая приставка Genius Heeha 600', price: 424, quantity: 4 } ] }; </script>
				<script type="text/javascript">
					window.ad_products = [{"id": "290230"}];
