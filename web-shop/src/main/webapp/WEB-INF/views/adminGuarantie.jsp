...
<c:set var="action" value="${pageContext.request.contextPath}/admin/admincontent/updatedGuarantie" />


<div style = "width:800px; padding-left:4%;" id = "form">
<h1>Вести гарантию:</h1>
<c:if test = "${result == 'success'}">
<div id = "success"><p>Вид гарантии успешно сохранен!</p></div>
</c:if>
<form:form method="post" action = "${action}"  modelAttribute="guarantie" enctype="multipart/form-data">
<ul>
	...
	<c:if test = "${type == 'update'}">
		...
		<li>
		<div id = "row">
			<div id = "col1"><form:label path="periodtype">
				Временной период:
			</form:label></div>
		
			<div id = "col2"><form:input path="periodtype" /><form:errors path="periodtype" cssClass="error" /></div>
	...
	<li>
		<div id = "row">
			...
			<div id = "col2">
			<form:input type = "text" path = "count" id = "count"/>
