...
<jsp:include page="/WEB-INF/views/maininfo.jsp" />
</c:if>
...
<jsp:include page="/WEB-INF/views/topgoods.jsp" />
</c:if>
...
<jsp:include page="/WEB-INF/views/mainactions.jsp" />
</c:if>

<div class="probel"></div>

<c:if test = "${!empty config && config.hasNewsOnMain == true}">
<jsp:include page="/WEB-INF/views/mainnews.jsp" />
</c:if>
