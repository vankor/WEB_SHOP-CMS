...
//        dataType: "text",
 ...
 //       	alert(data);
	...
	<jsp:include page="/WEB-INF/views/template/brands.jsp" />
	<c:if test = "${section == 'all'||empty section}">
<jsp:include page="/WEB-INF/views/template/goodpart_all.jsp"/>
</c:if>
...
<c:if test = "${section != 'all'}">
        ...
        <ul class="tabline" id="tabline" style="position: absolute;">
   			 ...
   			 <jsp:include page="/WEB-INF/views/template/goodpart_common.jsp" />
            
            <div id = "speccontent">
            <c:if test = "${section ==  'features'}">
    		   <jsp:include page="/WEB-INF/views/template/goodpart_features.jsp" />
            </c:if>
   
            <c:if test = "${section ==  'media'}">
	
				<jsp:include page="/WEB-INF/views/template/goodpart_media.jsp" />
			</c:if>
           
            
 			<c:if test = "${section ==  'voices'}">     
					<jsp:include page="/WEB-INF/views/template/goodpart_voices.jsp" />
 			</c:if>           
  
 			<c:if test = "${section ==  'others'}">           
      		     <jsp:include page="/WEB-INF/views/template/goodpart_others.jsp" />
 ...
 <jsp:include page="/WEB-INF/views/template/goodpart_common_bottom.jsp" />
 </div>
  
 <div id = "sidecontent">
 <jsp:include page="/WEB-INF/views/template/goodserviceinfo.jsp" />
         <div style="display:none; width: 256px; float: left; padding-top: 50px;">
         
			<jsp:include page="/WEB-INF/views/template/deliveryinfo.jsp" />
			<jsp:include page="/WEB-INF/views/template/subscribe.jsp" />
			<jsp:include page="/WEB-INF/views/template/ordercall.jsp" />
