...
<c:set var="action" value="${pageContext.request.contextPath}/admin/admincontent/updatedNewstype" />


<div style = "width:800px; padding-left:4%;" id = "form">
<h1>Вести тип новостей:</h1>
<c:if test = "${result == 'success'}">
<div id = "success"><p>Тип новостей успешно сохранен!</p></div>
</c:if>
<form:form method="post" action = "${action}"  modelAttribute="nwstype" enctype="multipart/form-data">
<ul>
